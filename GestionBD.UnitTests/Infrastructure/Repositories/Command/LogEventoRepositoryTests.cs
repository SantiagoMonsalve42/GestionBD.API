...
public sealed class LogEventoRepositoryTests
{
    [Fact]
    public void Create_ValidContext_ReturnsRepository()
    {
        ...
        var repository = new LogEventoRepository(contextMock.Object);

        Assert.NotNull(repository);
        Assert.IsAssignableFrom<ILogEventoRepository>(repository);
    }
}