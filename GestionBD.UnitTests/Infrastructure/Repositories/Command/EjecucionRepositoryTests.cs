...
public sealed class EjecucionRepositoryTests
{
    [Fact]
    public void Create_ValidContext_ReturnsRepository()
    {
        ...
        var repository = new EjecucionRepository(contextMock.Object);

        Assert.NotNull(repository);
        Assert.IsAssignableFrom<IEjecucionRepository>(repository);
    }
}